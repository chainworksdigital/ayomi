...
export default function WorkshopPage() {
  ...
  const fallbackEmbedURL =
    "https://www.youtube.com/embed/oV74Najm6Nc?autoplay=1";
          ...
          <div className="flex-1 space-y-6">
            ...
            >
              {loading ? (
                ...
                // Offline video container with 1080×1920 resolution (aspect ratio 9:16)
                <div className="relative w-full max-w-[1080px] aspect-[9/16] mx-auto">
                  <video
                    controls
                    className="absolute top-0 left-0 w-full h-full"
                    poster="/images/video_placeholder.png" // Optional poster image
                  >
                ...
                <iframe
                  src={webinarData.videoLink || fallbackEmbedURL}
                  title="Webinar Video"
                  frameBorder="0"
